...
public class ContactSpinner_Adapter extends ArrayAdapter<String> implements Filterable, ISpinnerSelectedView {

    private Context mContext;
    private ArrayList<String> mBackupStrings;
    private ArrayList<String> mStrings;
    private ArrayList<String> mStrings_id;
    private StringFilter mStringFilter = new StringFilter();

    public ContactSpinner_Adapter(Context context, ArrayList<String> strings, ArrayList<String> strings_id) {
        super(context, R.layout.view_list_item);
        mContext = context;
        mStrings = strings;
        mStrings_id = strings_id;
